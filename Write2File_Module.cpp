    ...
    for (SP_Message_Block_Base *msg = 0; get(msg) != -1;)
    {
        ...
        while (offset < 26)
        {
            if (offset1 == 0 && data->single_str_count_[offset] != 0)
            {
                ...
                single_write_count += fwrite(single_str_buf, sizeof(char), size, fp_out);
                ...
                while(data->single_str_count_[offset] != 0)
                {
                    ...
                    } else
                    {
                        ...
                        single_write_count += fwrite(single_str_buf, sizeof(char), count * 2, fp_out);
                    }
                    data->single_str_count_[offset] -= count;
                }
            }
            ...
            for (i = 0; i < c_data->vec_buf_wt_.size(); ++i)
            {
                ...
                if (buf->wt_pos != 0)
                    write_count += fwrite(buf->ptr, sizeof(char), buf->wt_pos, fp_out);
