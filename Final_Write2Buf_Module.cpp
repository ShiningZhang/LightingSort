...
Final_Write2Buf_Module::Final_Write2Buf_Module(int threads)
    :threads_num_(threads)
{
}


Final_Write2Buf_Module::~Final_Write2Buf_Module()
{
}


int
Final_Write2Buf_Module::open()
{
...
Final_Write2Buf_Module::svc()
{
    ...
    for (SP_Message_Block_Base *msg = 0; get(msg) != -1;)
    {
        ...
        put_next(msg);
        gettimeofday(&t2,0);
        SP_DEBUG("Final_Write2Buf_Module=%ldms.\n", (t2.tv_sec-start.tv_sec)*1000+(t2.tv_usec-start.tv_usec)/1000);
    }
}

int
Final_Write2Buf_Module::init()
{
    return 0;
}
